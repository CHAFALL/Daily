...
<div style="margin: 100px;">
  ...
  <div class="movie-detail">
    ...
    <div class="center-column">
      ...
      <i v-if="isLiked" class="fas fa-heart" style="color: pink;"></i>
      <i v-else class="far fa-heart" style="color: pink;"></i>
      {{ isLiked ? '좋아요 취소' : '좋아요' }}
      </button>
      ...
      <!-- 유튜브 이동 -->
      <button @click="toggleVideoPlay" style="color: azure; font-size: 24px;">트레일러 보기<img style="width: 45px;" src="@/assets/youtube.png" alt="youtube"></button>
...
.liked {
  color: pink; /* Change color to red when liked */
  margin-right: 25px;
  font-size: 25px;
}

.not-liked {
  color: pink; /* Change color to green when not liked */
  margin-right: 25px;
  font-size: 25px;
}
